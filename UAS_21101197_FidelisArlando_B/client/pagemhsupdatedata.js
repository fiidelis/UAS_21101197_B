function updatedata(){
    ...
    gh.open("POST","http://localhost/UAS_21101197_FidelisArlando_B/server/dtmhsupdate.php");
    ...
    gh.onload = function(){
        ...
        setTimeout(()=>{
            window.location.href="http://localhost/UAS_21101197_FidelisArlando_B/client/index.php?p=mhs";
        },5000);
    }
